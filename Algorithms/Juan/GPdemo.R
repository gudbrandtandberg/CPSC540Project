...
nStock=90 #this is the number of the stock you want to plot
...
today=260 #Final day where you have data
lookback=200 #How many days in the past you want to use to train your GP
horizon=2 #Number of days into the future you want to predict
